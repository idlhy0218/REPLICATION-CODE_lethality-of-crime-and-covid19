...
# =============================================================================
# Description : County-month panel ITS analysis using CDC cause-of-death data
...
process_year_data <- function(year) {
  ...
  dat <- read_rds(paste0(basefolder, "Data/CDC mortality_2016_2022/cleaned_data(", year, ")_260218.rds"))
  dat <- dat %>%
  ...
  saveRDS(dat, sprintf(paste0(basefolder, "Data/CDC mortality_2016_2022/recoded_data(%d)_260312.rds"), year))
  cat("  Saved year:", year, "\n")
}
...
load_year_data <- function(year) {
  readRDS(sprintf(paste0(basefolder, "Data/CDC mortality_2016_2022/recoded_data(%d)_260312.rds"), year)) %>%
...
saveRDS(county_all_years_combined,
        paste0(basefolder, "Data/CDC mortality_2016_2022/cdc_monthly_clean_data.RDS"))
...
ucr_assault <- readRDS(paste0(basefolder, "Data/UCR known offense_2016_2024/countylevel_consistent report_2016_2024 (known to police).RDS")) %>%
  filter(year <= 2022) %>%
...
cdc <- readRDS(paste0(basefolder, "Data/CDC mortality_2016_2022/cdc_monthly_clean_data.RDS")) %>%
...
plot_fig(make_fig(model_total,  df_total),  "")
ggsave(paste0(basefolder, "Figures/Extended Data Fig 9b.png"), 
